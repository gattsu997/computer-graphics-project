...
drawstring(-3.5,-0.5,0.0,"* Congestion control concerns controlling trafficentry into a ");
...
setFont(GLUT_BITMAP_TIMES_ROMAN_24);
 glColor3f(0.0,1.0,1.0);
drawstring(-2,1,0,"Mayank (USN : 1BI20CS105)");
setFont(GLUT_BITMAP_TIMES_ROMAN_24);
 glColor3f(0.0,1.0,1.0);
drawstring(-2,.5,0,"Pranav (USN : 1BI20CS123)");
